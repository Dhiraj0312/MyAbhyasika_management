                                  ...
                                  <table id="zctb" class="table table-striped table-bordered no-wrap">
                                    ...
                                    while($row=$res->fetch_object())
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><img src='<?php echo $row->profile;?>' height='90px' width='90px'></td>
                                            <td><b>Name : <?php echo $row->firstName;?> <?php echo $row->middleName;?> <?php echo $row->lastName;?></b><br>
                                            <?php echo $row->dob;?><br>
                                            <a href="<?php echo $row->adharphoto;?>">Aadhar Photo</a>
                                         ...
                                         <!-- Inside the table where you want to display the images -->
