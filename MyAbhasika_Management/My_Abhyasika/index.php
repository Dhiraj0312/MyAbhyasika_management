    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row">
                <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url(assets/images/backman.jpg);">
                </div>
                    ...
                    <div class="p-3">
                        ...
                        <form class="mt-4" method="POST">
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center">
                                    <!-- <button  class="btn btn-block btn-white">OR</button> -->OR
                                </div>
                                <!-- <div class="col-lg-12 text-center">
                                    <button  name="register" class="btn btn-block btn-orange" >REGISTER</button>
                                </div> -->

                                <div class="col-lg-12 text-center mt-2">
    <a href="student/signup.php" class="btn btn-block btn-info">Sign Up</a>
</div>
