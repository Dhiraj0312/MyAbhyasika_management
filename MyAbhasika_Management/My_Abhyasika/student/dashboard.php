        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- *************************************************************** -->
                    ...
                    <!-- Add the Student ID Card here for each student -->
                    <div class="card mb-4">
                        <div class="card-header bg-primary text-white">
                            <h5 class="card-title">Student ID Card</h5>
                        </div>
                        <div class="card-body">
                            <!-- Insert the ID card content here -->
                            ...
                            <p class="card-text">Batch: <?php echo $row->postingDate;?></p>
                            <p class="card-text">Program: Computer Science</p>
                            <p class="card-text">Contact: <?php echo $row->contactNo; ?></p>
                        </div>
                    </div>
                    <!-- End Student ID Card -->
                <?php
