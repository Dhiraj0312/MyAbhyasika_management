        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Student Sign Up</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Contact Number</h4>
                                        <div class="form-group">
                                        <input type="number" name="contact" id="contact" placeholder="Your Contact" required="required" class="form-control" min="1000000000" max="9999999999" oninput="validateContact(this)"><p id="contactError" style="color: red;"></p>
                                        </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Password</h4>
                                        <div class="form-group">
                                        <input type="password" name="password" id="password" placeholder="Enter Password" required="required" class="form-control" oninput="validatePassword(this)"><p id="passwordError" style="color: red;"></p>
                                        </div>
                                </div>
                            </div>
                        </div>
...
function validateContact(input) {
  const inputValue = input.value.toString(); // Convert input to string
  const contactError = document.getElementById("contactError");

  if (inputValue.length !== 10) {
    contactError.textContent = "Please enter a 10-digit number.";
...
function validatePassword(input) {
  ...
  if (!regex.test(password)) {
    passwordError.textContent = "Password must be at least 8 characters long and contain at least one letter, one digit, and one special character.";
