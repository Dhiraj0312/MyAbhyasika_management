...
<div class="container py-4">
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="manage_payment.php" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  New Payment</a>
            </div>
        </div>
        <div class="card-body">
    ...
    <tbody>
        <?php 
        $i = 1;
        $qry = $mysqli->query("SELECT * FROM `transaction_list` 
